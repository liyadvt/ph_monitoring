...
<div class="title">
    <h4 class="text-primary align-middle mt-4 mb-0">Setup New Documentation</h4>
    <br>
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="w-100">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-10">
                                    <textarea class="form-control" name="documentation_description" id="documentation_description" rows="5"></textarea>
                                </div>
